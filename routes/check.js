...
var ege = 'http://egeduyuru.ege.edu.tr/index.php?bolumid=2';
...
var getUpToDateAnnc = function (callback) {
    ...
    function callback123(err, resp, body) {
        ...
        if (!err && resp.statusCode == 200) {
            ...
            var findFunc = function (obj, done) {
                var cont_url = absHref + $(obj).children().children().children().attr('href');
...
var doRoutineCheck = function (callback) {
...
var checkForNew = function (callback) {
    ...
    function callback2(err, resp, body) {
        ...
        if (!err && resp.statusCode == 200) {
            ...
            $('td[width=365]').each(function (i, element) {
                ...
                var cont_url = absHref + $(this).children().children().children().attr('href');
...
var writeToDB = function (callback) {
    var cb_list = [];
...
var writeToDBNew = function (list, callback) {
        var insideList = list;
    ...
    // Veritabanindaki en guncel duyuruyu alir, urlsini last_url atar
    // Rutin kontrol isleminin ilkini baslatir
...
var getContentOfAnnc = function (url_, callback) {
    var content;
...
module.exports.getUpToDateAnnc = getUpToDateAnnc;
module.exports.getContentOfAnnc = getContentOfAnnc;
module.exports.getFromStrach = getFromStrach;
module.exports.writeToDB = writeToDB;
module.exports.doRoutineCheck = doRoutineCheck;
module.exports.getLastAnnc = getLastAnnc;
module.exports.checkForNew = checkForNew;